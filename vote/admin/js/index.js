	window.onload = function (){
		...
		var deltheme = document.getElementsByName('deltheme');	
		var delnotice = document.getElementsByName('delnotice');
		var noticeform = document.getElementsByName('noticeform')[0];
		var delguest = document.getElementsByName('delguest');
